...
export const Slider = () => {
  ...
  return (
    <section className="relative">
      ...
      <p className="hidden lg:inline-block absolute top-5 right-20 w-1/3 mb-6 text-base text-right text-gray-700">
      ...
      <div className="sm:px-2 md:px-5 lg:px-20 bg-slate-200">
