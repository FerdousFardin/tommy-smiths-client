...
export const Header = () => {
  ...
  const activeClassName = "text-teal-accent-400";
  return (
          ...
          <ul className="items-center hidden space-x-8 lg:flex">
            ...
            {user?.email ? (
              <>
                ...
                <li>
                  <button
                    onClick={() => signOutUser().then().catch()}
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      ...
                      >
                        ...
                        <span className="ml-2 md:text-2xl lg:text-3xl text-xl font-thin tracking-wide text-gray-900 uppercase">
                          <span className="text-pink-accent-100">Tommy </span>{" "}
                          Smith
                        </span>
                      </NavLink>
                    </div>
